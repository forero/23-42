...
\noindent\textsc{C\'odigo del curso:} FISI-XXXX. CBU Tipo E (intensivo en
escritura acad\'emica).  Como tipo A/B dependiendo de la
clasificaci\'on del comit\'e de CBU.  %Aqui el 
                                %codigo del curso 
...
astrobiolog\'ia. El curso es apto para estudiantes de cualquier
disciplina y nivel de estudios. El \'unico requisito es el inter\'es
por los temas a tratar. \\[0.1cm]  
...
dan estructura a sociedades. \\[-0.3cm] 
...
Tierra. Astrobiolog\'ia b\'asica y la b\'usqueda cient\'ifica de vida
extraterrestre. \\[-0.3cm]  

\noindent\textbf{\textsc{Semana 9.}} Nuevos mundos. Exoplanetas y la
b\'usqueda de nuevos mundos habitables .\\[-0.3cm] 
...
\begin{itemize}
\item Carl Sagan. \textit{Cosmos: una evolución cósmica de
  quince mil millones de años que ha transformado la materia
  en vida y en consciencia}, 1982. (Biblioteca General -
  523.1 S131 Z258 )
\end{itemize}
...
\item Andrew M. Shaw. \textit{Astrochemistry: from astronomy to astrobiology}, A\~no. (Biblioteca General -
  523.02 S318 )\\[-0.6cm]
